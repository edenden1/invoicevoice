...
export default function InvoicePreviewScreen() {
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      if (invoiceId) {
        ...
        await invoiceApi.create(buildPayload());
      }
  ...
  const handleSendNow = async () => {
    ...
    try {
      let invoice: Invoice;
      if (invoiceId) {
        invoice = await invoiceApi.update(invoiceId, buildPayload());
      } else {
        invoice = await invoiceApi.create(buildPayload());
      }
  ...
  return (
    ...
    >
      ...
      >
        <Text style={styles.heading}>Review Your Invoice</Text>
        <Text style={styles.subheading}>
          Verify the details extracted from your voice recording.
        </Text>
